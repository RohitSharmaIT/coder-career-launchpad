    ...
    <section className="relative min-h-[70vh] w-full bg-gradient-to-br from-gray-900 via-gray-800 to-brand-red flex items-center justify-center">
      ...
      <div className="relative container-full flex items-center justify-center min-h-[70vh]">
        <div className="max-w-5xl mx-auto text-center px-4 md:px-8">
          ...
          {/* Headline */}
          <h1 className="text-5xl md:text-7xl font-bold mb-8 animate-fade-in text-white leading-tight max-w-3xl mx-auto" style={{animationDelay: '0.2s'}}>
            Level Up Your{" "}
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center animate-fade-in" style={{animationDelay: '0.8s'}}>
            <Link to="/book-slot">
              <Button className="bg-brand-red hover:bg-red-600 text-white text-xl px-10 py-6 rounded-full font-semibold group shadow-2xl hover:shadow-red-500/25 transition-all duration-300 transform hover:scale-105">
                Get Started Today
          ...
          {/* Trust Indicators */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-12 mt-16 pt-8 border-t border-white/20 animate-fade-in" style={{animationDelay: '1s'}}>
