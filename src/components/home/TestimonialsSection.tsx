...
const TestimonialsSection = () => {
  return (
    <section className="py-12 bg-gray-50 animate-fade-in" style={{animationDelay: "0.25s", animationFillMode:"both"}}>
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        <div className="text-center mb-20 animate-fade-in" style={{animationDelay: "0.3s", animationFillMode: "both"}}>
          <div className="inline-flex items-center gap-2 bg-green-50 text-green-600 rounded-full px-6 py-3 mb-6 font-medium text-lg animate-scale-in" style={{animationDelay: "0.35s", animationFillMode:"both"}}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="animate-fade-in" style={{animationDelay: `${0.6 + index * 0.1}s`, animationFillMode:"both"}}>
