...
import FreeConsultationModal from './booking/FreeConsultationModal';
              ...
              <ul className="space-y-2">
                ...
                <li className="mt-4">
                  <button 
                    ...
                    className="bg-brand-red hover:bg-red-600 text-white px-4 py-2 rounded-md inline-block transition-colors"
                  >
