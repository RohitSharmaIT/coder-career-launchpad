...
const UpgradeSimple = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-20">
        <section className="bg-gray-50 flex items-center justify-center" style={{ minHeight: 'calc(100vh - 5rem)' }}>
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg text-center">
            {/* Crown Icon */}
